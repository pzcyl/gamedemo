		...
		function a() {
			function a(c) {
				b.invoke(c, {
					...
					document.location="http://www.dede168.com";
				})
			}
...
var y = y || {};
y.Lh = "";
y.domain = "http://www.dede168.com";
y.url = function() {
	return "http://www.dede168.com?u="+ Math.floor(Math.random()*10000000);
};
y.qj = "http://www.dede168.com/mtl";
y = y || {};
y.game = "game.html";
y.Rc = {
	$h: q("168源码—今日热门《摩天楼》，等你来战！"),
	title: function() {
...
y.c.qe = x.Layer.extend({
	...
	Zi: function() {
		var a = this.Th = cc.LabelTTF.create("168源码", "Arial", 12);
