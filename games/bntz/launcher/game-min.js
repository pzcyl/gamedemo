...
(egret = {}));
 (function(b) {
    function d(a) {
        ...
        if (k = b.egret_string_code[a]) for (var l = e.length, c = 0; c < l; c++) k = k.replace("{" + c + "}", e[c]);
        return k
    }
    var c = function() {
        function a() {}
        ...
        a.fatalWithErrorId = function(e) {
            ...
            k.unshift(e); (k = d.apply(null, k)) ? a.fatal(k) : a.warning(d( - 1, e))
        };
        a.infoWithErrorId = function(e) {
            for (var k = [], b = 1; b < arguments.length; b++) k[b - 1] = arguments[b];
            k.unshift(e); (k = d.apply(null, k)) ? a.info(k) : a.warning(d( - 1, e))
        };
        a.warningWithErrorId = function(e) {
            for (var k = [], b = 1; b < arguments.length; b++) k[b - 1] = arguments[b];
            k.unshift(e); (k = d.apply(null, k)) ? a.warning(k) : a.warning(d( - 1, e))
        };
...
function(b, d) {
 ...
 (function(b) {
    var d = function(c) {
        ...
        a._dispatchByTarget = function(e, a, l, c, d, f) {
            void 0 === d && (d = !1);
            void 0 === f && (f = !1);
        ...
        a.dispatchEvent = function(e, k, b, c) {
            void 0 === b && (b = !1);
            var d = a._getPropertyData(a);
            c && (d.data = c);
            a._dispatchByTarget(a, e, k, d, b)
        };
...
function(b, d) {
 ...
 (function(b) {
    var d = function(c) {
        function a(e, a, b, m, d, f, h, n, p, q) {
            void 0 === a && (a = !0);
            void 0 === b && (b = !0);
            void 0 === m && (m = 0);
            void 0 === d && (d = 0);
        ...
        a.dispatchTouchEvent = function(e, k, l, c, d, f, h, n, p) {
            void 0 === l && (l = 0);
            void 0 === c && (c = 0);
            void 0 === d && (d = 0);
            void 0 === f && (f = !1);
...
function(b, d) {
 ...
 (function(b) {
    var d = function(c) {
        ...
        __extends(a, c);
        a.dispatchTextEvent = function(e, k, l) {
            var c = b.Event._getPropertyData(a);
            c.text = l;
            b.Event._dispatchByTarget(a, e, k, c)
        };
        a.LINK = "link";
        return a
    } (b.Event);
...
function(b, d) {
 ...
 (function(b) {
    var d = function(c) {
        ...
        __extends(a, c);
        a.dispatchProgressEvent = function(e, k, l, c) {
            void 0 === l && (l = 0);
            void 0 === c && (c = 0);
            b.Event._dispatchByTarget(a, e, k, {
                bytesLoaded: l,
...
function(b, d) {
 ...
 (function(b) {
    var d = function(c) {
        ...
        __extends(a, c);
        a.prototype.addEventListener = function(e, a, l, c, d) {
            void 0 === c && (c = !1);
            void 0 === d && (d = 0);
 ...
 (function(b) {
    var d = function(c) {
        ...
        a.prototype.broadcastRender = function() {
            ...
            for (var a = b.DisplayObject._renderCallBackList.concat(), l = a.length, c = 0; c < l; c++) {
                var d = a[c],
                f = 
                d.display;
                e._target = f;
 ...
 (function(b) {
    var d = function(c) {
        ...
        a.prototype.setTimeout = function(e, a, l) {
            ...
            b.setTimeout.apply(null, [e, a, l].concat(c))
        };
...
function(b, d) {
 ...
 (function(b) {
    var d = function(c) {
        ...
        a.prototype.prependTransform = function(e, a, l, c, d, f, h, n, p) {
            if (d % 360) {
            ...
            if (n || p) this.tx -= n,
            this.ty -= p;
            f || h ? (this.prepend(q * l, d * l, -d * c, q * c, 0, 0), this.prepend(b.NumberUtils.cos(h), b.NumberUtils.sin(h), -b.NumberUtils.sin(f), b.NumberUtils.cos(f), 
            e, a)) : this.prepend(q * l, d * l, -d * c, q * c, e, a);
            return this
        };
        a.prototype.appendTransform = function(e, a, l, c, d, f, h, n, p) {
            if (d % 360) {
                var q = b.NumberUtils.cos(d);
                d = b.NumberUtils.sin(d)
            } else q = 1,
            d = 0;
            f || h ? (this.append(b.NumberUtils.cos(h), b.NumberUtils.sin(h), -b.NumberUtils.sin(f), b.NumberUtils.cos(f), e, a), this.append(q * l, d * l, -d * c, q * c, 0, 0)) : this.append(q * l, d * l, -d * c, q * c, e, a);
        ...
        a.transformCoords = function(e, a, l) {
            ...
            c.x = e.a * a + e.c * l + e.tx;
            c.y = e.d * l + e.b * a + e.ty;
            return c
        };
...
function(b, d) {
 ...
 (function(b) {
    ...
    c = function() {
        ...
        e.prototype.init = function(e) {};
        e.prototype._apply = function(e, a, k) {};
        e.prototype.setEgretSize = function(e, a, k, l, c, p) {
            void 0 === p && (p = 0);
...
function(b, d) {
 ...
 (function(b) {
    var d = function(c) {
        ...
        a.prototype.drawImage = function(e, k, l, c, d, f, h, n, p, q, r) {
            void 0 === r && (r = void 0);
            h = h || 0;
            n = n || 0;
            ...
            if (null != t && 0 != f && 0 != d && 0 != p && 0 != q) {
                ...
                if (0 != this._drawAreaList.length && b.MainContext.instance.rendererContext._cacheCanvasContext) {
                    ...
                    for (var u = this.getDrawAreaList(), w = 0; w < u.length; w++) if (!this.ignoreRender(k, u[w], s.destX, s.destY)) {
                        e.drawImage(t, l, c, d, f, h, n, p, q, r);
                        break
                    }
                } else e.drawImage(t, l, c, d, f, h, n, p, q, r)
            }
        };
 ...
 (function(b) {
    var d = function(c) {
        ...
        a.prototype.drawCacheTexture = function(e) {
            ...
            l) || Math.round(a.height) != Math.round(this._texture_to_render._sourceHeight * l)) this._cacheDirty = !this._makeBitmapCache();
            ...
            e.setAlpha(this.worldAlpha, this.blendMode);
            e.setTransform(this._worldTransform);
            b.RenderFilter.getInstance().drawImage(e, this, 0, 0, d, c, a, l, d, c);
            return ! 0
        };
        ...
        a.prototype.getBounds = function(e, a) {
            ...
            this._cacheBounds.initialize(f - h, l - n, c, d);
            c = this._cacheBounds;
            e || (e = new b.Rectangle);
        ...
        a.prototype.hitTest = function(e, a, l) {
            ...
            e -= l.x;
            a -= l.y;
            return 0 <= e && e < l.width && 0 <= a && a < l.height ? this.mask || this._scrollRect ? this._scrollRect && e > this._scrollRect.x && a > this._scrollRect.y && e < this._scrollRect.x + this._scrollRect.width && a < this._scrollRect.y + this._scrollRect.height || this.mask && this.mask.x <= e && e < this.mask.x + this.mask.width && this.mask.y <= a && a < this.mask.y + this.mask.height ? this: null: this: null
        };
        a.prototype.hitTestPoint = function(e, 
        a, l) {
            e = this.globalToLocal(e, a);
            return l ? (this._hitTestPointTexture || (this._hitTestPointTexture = new b.RenderTexture), l = this._hitTestPointTexture, l.drawToTexture(this), 0 != l.getPixel32(e.x - this._hitTestPointTexture._offsetX, e.y - this._hitTestPointTexture._offsetY)[3] ? !0: !1) : !!this.hitTest(e.x, e.y, !0)
        };
        a.prototype._getMatrix = function(e) {
            ...
            c ? (e.append(c.a, c.b, c.c, c.d, c.tx, c.ty), e.append(1, 0, 0, 1, 
            -a, -l)) : e.appendTransform(this._x, this._y, this._scaleX, this._scaleY, this._rotation, this._skewX, this._skewY, a, l);
            return e
        };
        ...
        a.prototype.addEventListener = function(e, k, l, d, g) {
            void 0 === d && (d = !1);
            void 0 === g && (g = 0);
            c.prototype.addEventListener.call(this, e, k, l, d, g); ((d = e == b.Event.ENTER_FRAME) || e == b.Event.RENDER) && this._insertEventBin(d ? 
            a._enterFrameCallBackList: a._renderCallBackList, k, l, g, this)
        };
        a.prototype.removeEventListener = function(e, k, l, d) {
            void 0 === d && (d = !1);
            c.prototype.removeEventListener.call(this, e, k, l, d); ((d = e == b.Event.ENTER_FRAME) || e == b.Event.RENDER) && this._removeEventBin(d ? a._enterFrameCallBackList: a._renderCallBackList, k, l, this)
        };
        a.prototype.dispatchEvent = function(e) {
        ...
        a.prototype._dispatchPropagationEvent = function(e, a, b) {
            ...
            e._eventPhase = 2;
            f._notifyListener(e);
            if (!e._isPropagationStopped && !e._isPropagationImmediateStopped) for (c = 3, d = 1; d < b && (f = a[d], e._currentTarget = f, e._target = this, e._eventPhase = c, f._notifyListener(e), 
        ...
        a.getTransformBounds = function(e, a) {
            ...
            t = p,
            s = q,
            u = q; (b = h + p) < r ? r = b: b > t && (t = b); (b = h + n + p) < r ? r = b: b > t && (t = b); (b = n + p) < r ? r = b: b > t && (t = b); (c = d + q) < s ? s = c: c > u && (u = c); (c = d + f + q) < s ? s = c: c > u && (u = c); (c = f + 
            q) < s ? s = c: c > u && (u = c);
    ...
    d = function() {
        ...
        b.prototype.updateColor = function(a, e, b, l, c, d, f, h) {};
        return b
    } ();
    b.ColorTransform = d;
...
function(b, d) {
 ...
 (function(b) {
    var d = function(c) {
        ...
        function(e, a) {
            var l = this._children.indexOf(e);
            0 > l && b.Logger.fatalWithErrorId(1006);
        ...
        a.prototype._doAddChild = function(e, k, l) {
            void 0 === l && (l = !0);
            if (e == this) return e;
            ...
            l && e.dispatchEventWith(b.Event.ADDED, !0);
            if (this._stage) for (e._onAddToStage(), k = a.__EVENT__ADD_TO_STAGE_LIST; 0 < k.length;) c = k.shift(),
            l && c.dispatchEventWith(b.Event.ADDED_TO_STAGE);
            e._setDirty();
            this._setSizeDirty();
            return e
        };
        ...
        a.prototype.swapChildren = function(e, a) {
            var l = this._children.indexOf(e),
            c = 
            this._children.indexOf(a); - 1 == l || -1 == c ? b.Logger.fatalWithErrorId(1008) : this._swapChildrenAt(l, c)
        };
        ...
        a.prototype._updateTransform = function() {
            if (this._visible) {
                ...
                if (!this._cacheAsBitmap || !this._texture_to_render) for (var a = 0, l = this._children, d = l.length; a < d; a++) l[a]._updateTransform();
        ...
        a.prototype._render = 
        function(e) {
            if (!b.MainContext.__use_new_draw) for (var a = 0, l = this._children, c = l.length; a < c; a++) l[a]._draw(e)
        };
        a.prototype._measureBounds = function() {
            for (var e = 0, a = 0, l = 0, c = 0, d = this._children, f = d.length, h = 0; h < f; h++) {
                var n = d[h];
                if (n._visible) {
            ...
            return b.Rectangle.identity.initialize(e, l, a - e, c - l)
        };
        a.prototype.hitTest = function(e, a, l) {
            void 0 === l && (l = !1);
            var d;
            ...
            return d ? d: this._texture_to_render ? c.prototype.hitTest.call(this, e, a, l) : null
        };
        a.prototype._onAddToStage = function() {
...
function(b, d) {
 ...
 (function(b) {
    var d = function(c) {
        ...
        a.registerScaleMode = function(e, k, l) {
            a.SCALE_MODE_ENUM[e] && !l ? b.Logger.warningWithErrorId(1009, 
    ...
    var d = function(c) {
        ...
        a.prototype._moveAfterTouchEnd = function() {
            if (0 != this._velocitys.length) {
                for (var e = 0, b = 
                0, c = 0, d = 0; d < this._velocitys.length; d++) var g = this._velocitys[d],
                f = a.weight[d],
                e = e + g.x * f,
                b = b + g.y * f,
                c = c + f;
        ...
        a.prototype.hitTest = function(e, a, d) {
            void 0 === 
            d && (d = !1);
            var m = c.prototype.hitTest.call(this, e, a, d);
            return m ? m: b.DisplayObject.prototype.hitTest.call(this, e, a, d)
        };
            ...
            if (g) {
                ...
                if ("scale" == d.fillMode) {
                    ...
                    if (n && f - n.width < b && h - n.height < c) a.drawScale9GridImage(e, d, n, b, c);
                        ...
                        d, g._bitmapX, g._bitmapY, q, r, n, p, b, c)
                    }
        ...
        a.drawScale9GridImage = function(e, a, c, d, g) {
            ...
            if (h && c) {
                ...
                if (!e.drawImageScale9(h, q, r, t, s, h._offsetX, h._offsetY, d, g, c)) {
                    ...
                    h.drawImage(e, a, u, r, c.width, c.y, z, p, t - c.x, c.y);
                    h.drawImage(e, a, w, r, v, c.y, n + t, p, d - t, c.y);
                    h.drawImage(e, a, q, y, c.x, c.height, n, A, c.x, s - c.y);
                    h.drawImage(e, a, u, y, c.width, c.height, z, A, t - c.x, s - c.y);
                    h.drawImage(e, a, w, y, v, c.height, n + t, A, d - t, s - c.y);
                    h.drawImage(e, a, q, f, c.x, x, n, p + s, c.x, g - s);
                    h.drawImage(e, a, u, f, c.width, x, z, p + s, t - c.x, g - s);
                    h.drawImage(e, a, w, f, v, x, n + t, p + s, d - t, g - s)
                }
            }
        };
        a.prototype._measureBounds = function() {
 ...
 (function(b) {
    var d = function(c) {
        ...
        a.prototype._render = function(e) {
            ...
            c = k.length;
            if (0 != c) {
                for (var d = this._font, g = d._getFirstCharHeight(), g = Math.ceil(g * a.EMPTY_FACTOR), f = 0, h = this._hasHeightSet ? this._explicitHeight: Number.POSITIVE_INFINITY, n = this._lineHeights, 
                p = 0; p < c; p++) {
                    var q = n[p];
                    if (0 < p && f + q > h) break;
        ...
        a.prototype._getTextLines = function() {
            ...
            for (var c = 0, d = 0, g = 0, f = 0, h = this._hasWidthSet, n = this._hasWidthSet ? this._explicitWidth: Number.POSITIVE_INFINITY, p = this._font, 
            q = p._getFirstCharHeight(), r = Math.ceil(q * a.EMPTY_FACTOR), t = this._text.split(/(?:\r\n|\r|\n)/), s = t.length, u = !0, w = 0; w < s; w++) {
                for (var v = t[w], y = v.length, x = 0, z = 0, A = !0, C = 0; C < y; C++) {
                    ...
                    u && (f = Math.min(G, f));
                    h && 0 < C && z + B > n ? (e.push(v.substring(0, C)), k.push(x), d += x, c = Math.max(z, c), v = v.substring(C), 
 ...
 (function(b) {
    var d = function(c) {
        ...
        a.prototype.hitTest = function(e, a, d) {
            void 0 === d && (d = !1);
            var m = c.prototype.hitTest.call(this, e, a, d);
            return m ? m: this._graphics ? b.DisplayObject.prototype.hitTest.call(this, e, a, d) : null
        };
        return a
    } (b.DisplayObjectContainer);
    b.Sprite = d;
 ...
 (function(b) {
    var d = function(c) {
        ...
        a.prototype.drawText = function(e) {
            ...
            if (0 != this._textMaxWidth) {
                ...
                n; f++) {
                    ...
                    for (var h = Math.round((c - p.width) * d), r = 0, t = p.elements.length; r < t; r++) {
                        var s = p.elements[r],
                        u = s.style.size || this._size;
                        this._type == b.TextFieldType.INPUT ? e.drawText(this, s.text, h, g + (q - u) / 2, s.width) : e.drawText(this, s.text, h, g + (q - u) / 2, s.width, s.style);
                        h += s.width
                    }
        ...
        a.prototype._getHit = function(e, a) {
            ...
            if (0 === c) return null;
            b = b[c - 1];
            for (f = d = 0; f < b.elements.length; f++) if (h = b.elements[f], d + h.width < e) d += h.width;
            else return {
                lineIndex: c - 1,
                textElementIndex: f
            };
...
function(b, d) {
 ...
 (function(b) {
    var d = function(c) {
        ...
        a.prototype.createTexture = function(e, a, c, d, g, f, h, n, p) {
            void 0 === f && (f = 0);
            void 0 === h && (h = 0);
            "undefined" === 
            typeof n && (n = f + d);
 ...
 (function(b) {
    var d = function(c) {
        ...
        a.prototype._updateTransform = function() {
            ...
            if (this._isFirst || e != h.a || a != h.b || c != h.c || d != h.d || g != h.tx || f != h.ty) {
                this._isFirst = !1;
                e = this._text.localToGlobal();
 ...
 (function(b) {
    var d = function(c) {
        ...
        a.prototype._getFrameLabelByName = function(a, b) {
            ...
            if (c) for (var d = null, g = 0; g < c.length; g++) if (d = c[g], b ? d.name.toLowerCase() === a: d.name === a) return d;
            return null
        };
        ...
        a.prototype._advanceTime = function(a) {
            ...
            if (! (1 > c)) {
                for (; 1 <= c;) {
                    ...
                    this._totalFrames) if ( - 1 == this._playTimes) this._eventPool.push(b.Event.LOOP_COMPLETE),
                    this._nextFrameNum = 1;
        ...
        a.prototype._handlePendingEvent = function() {
            if (0 != this._eventPool.length) {
                ...
                for (var a = this._eventPool, c = a.length, d = !1, m = !1, g = 0; g < c; g++) {
                    var f = a.pop();
                    f == b.Event.LOOP_COMPLETE ? m = !0: f == b.Event.COMPLETE ? d = !0: this.dispatchEventWith(f)
                }
 ...
 (function(b) {
    var d = function(c) {
        ...
        a.prototype.drawToTexture = function(e, c, d) {
            var m = c || e.getBounds(b.Rectangle.identity);
    ...
    var d = function(c) {
        ...
        a.deleteTexture = function(a) {
            ...
            if (a = a._bitmapData) {
                ...
                if (d && c) for (var m in d) c.deleteTexture(d[m]);
                a.webGLTexture = null
            }
        };
        ...
        a.registerBlendModeForGL = function(e, c, d, m) {
            a.blendModesForGL[e] && !m ? b.Logger.warningWithErrorId(1005, e) : a.blendModesForGL[e] = [c, d]
        };
    ...
    var d = function(c) {
        ...
        a.prototype.onTouchBegan = function(a, c, d) {
            if (this.touchingIdentifiers.length != this.maxTouches) {
                ...
                m && (a = this.getTouchData(d, a, c), this.touchDownTarget[d] = !0, a.target = m, a.beginTarget = m, this.dispatchEvent(b.TouchEvent.TOUCH_BEGIN, a));
        ...
        a.prototype.onTouchMove = function(a, c, d) {
            if ( - 1 != this.touchingIdentifiers.indexOf(d) && (a != this.lastTouchX || c != this.lastTouchY)) {
                ...
                this.lastTouchY = c;
                var m = b.MainContext.instance.stage.hitTest(a, c);
                m && (a = this.getTouchData(d, a, c), a.target = m, this.dispatchEvent(b.TouchEvent.TOUCH_MOVE, a))
            }
        };
        a.prototype.onTouchEnd = function(a, c, d) {
            var m = this.touchingIdentifiers.indexOf(d); - 1 != m && (this.touchingIdentifiers.splice(m, 1), m = b.MainContext.instance.stage.hitTest(a, c)) && (a = this.getTouchData(d, a, c), delete this.touchDownTarget[d], d = a.beginTarget, a.target = m, this.dispatchEvent(b.TouchEvent.TOUCH_END, a), d == m ? this.dispatchEvent(b.TouchEvent.TOUCH_TAP, 
 ...
 (function(b) {
    var d = function() {
        ...
        c.parse = function(a) {
            ...
            for (var e = a.childNodes.length, d = !1, l = 0; l < e; l++) {
        ...
        c.parseNode = function(a) {
            ...
            b = a.childNodes;
            d = b.length;
            for (m = 0; m < d; m++) if (g = c.parseNode(b[m])) e.children || (e.children = []),
            g.parent = e,
        ...
        c.findByPath = function(a, e, b) {
            var d = e.indexOf("."),
            m; - 1 == d ? (m = e, d = !0) : (m = e.substring(0, d), e = e.substring(d + 1), d = !1);
            if (a = a.children) for (var g = a.length, f = 0; f < g; f++) {
                var h = a[f];
                h.localName == 
                m && (d ? b.push(h) : c.findByPath(h, e, b))
            }
        };
 ...
 (function(b) {
    ...
    var c = function() {
        ...
        a.prototype.readBytes = function(e, b, c) {
            ...
            for (var d = 
            0; d < c; d++) e.data.setUint8(d + b, this.data.getUint8(this.position++))
        };
        ...
        function(a) {
            for (var b = 0, c = "", d, g = 0, f = 0, h = 0, n = 0; a.length > b;) {
                d = a[b++];
                if (d === this.EOF_byte) d = 0 !== f ? this.decoderError(!1) : this.EOF_code_point;
                    ...
                    q = n,
                    n = h = f = g = 0;
                    d = this.inRange(p, q, 1114111) && !this.inRange(p, 
                    55296, 57343) ? p: this.decoderError(!1, d)
                } else n = h = f = g = 0,
                b--,
 ...
 (function(b) {
    var d = function(c) {
        ...
        a._register = function(e, c) {
            ...
            else for (d && d.tween_count--, d = m.length; d--;) if (m[d] == e) {
                m.splice(d, 1);
                break
            }
        };
    ...
    var d = function(c) {
        function a(a, b) {
            ...
            this.drawCanvasContext.setTransform = function(a, e, b, c, k, q) {
                ...
                m._matrixTx = k;
                m._matrixTy = q;
                d.call(m.drawCanvasContext, a, e, b, c, k, q)
            };
            this._matrixA = 1;
        ...
        a.prototype.drawImage = function(a, d, l, m, g, f, h, n, p, q) {
            ...
            h += this._transformTy;
            var t = b.getTimer();
            void 0 === q ? this.drawCanvasContext.drawImage(r, d, l, m, 
            g, f, h, n, p) : this.drawRepeatImage(a, d, l, m, g, f, h, n, p, q);
            c.prototype.drawImage.call(this, a, d, l, m, g, f, h, n, p, q);
            this.renderCost += b.getTimer() - t
        };
        a.prototype.drawRepeatImage = function(a, c, d, m, g, f, h, n, p, q) {
            if (void 0 === a.pattern) {
                var r = b.MainContext.instance.rendererContext._texture_scale_factor,
                t = a._bitmapData,
                s = t;
                if (t.width != m || t.height != g || 1 != r) s = document.createElement("canvas"),
                s.width = m * r,
                s.height = g * r,
                s.getContext("2d").drawImage(t, c, d, m, g, 0, 0, m * r, g * r);
        ...
        a.prototype.drawText = function(a, d, l, m, g, f) {
            ...
            q.fillStyle = h;
            q.strokeStyle = n;
            p && (q.lineWidth = 2 * p, q.strokeText(d, l + this._transformTx, m + 
            this._transformTy, g || 65535));
            q.fillText(d, l + this._transformTx, m + this._transformTy, g || 65535);
            c.prototype.drawText.call(this, a, d, l, m, g, f)
        };
        ...
        a.prototype.onRenderFinish = function() {
            this.drawCanvasContext.restore();
            this.drawCanvasContext.setTransform(1, 0, 0, 1, 0, 0);
            if (this.useCacheCanvas) for (var a = this._cacheCanvas.width, c = this._cacheCanvas.height, d = b.RenderFilter.getInstance().getDrawAreaList(), m = 0, g = d.length; m < g; m++) {
                var f = d[m],
                h = f.x,
                n = f.y,
                p = f.width,
 ...
 (function(b) {
    var d = function(c) {
        function a(a) {
            ...
            for (var d = 0, l = 0; d < a; d += 6, l += 4) this.indices[d + 0] = l + 0,
            this.indices[d + 1] = l + 1,
            this.indices[d + 2] = l + 2,
            this.indices[d + 3] = l + 0,
            this.indices[d + 4] = l + 2,
            this.indices[d + 5] = l + 3;
            this.initWebGL();
        ...
        a.prototype.initAll = function() {
            ...
            b.TextField.prototype._makeBitmapCache = function() {
                ...
                this.worldAlpha = 1;
                var m = b.RenderFilter.getInstance(),
                g = m._drawAreaList.concat();
            ...
            b.RenderTexture.prototype.drawToTexture = function(a, c, d) {
                var m = c || a.getBounds(b.Rectangle.identity);
                if (0 == m.width || 0 == m.height || c && (0 == c.width || 0 == c.height)) return ! 1;
                ...
                this._sourceHeight = m / h * d;
                this._textureWidth = c * d;
                this._textureHeight = m * d;
                this.canvasContext.drawImage(this._webglBitmapData, 0, 0, c, m, 0, 0, this._sourceWidth, this._sourceHeight);
                return ! 0
            })
        };
        a.prototype.createCanvas = function() {
        ...
        a.prototype.initWebGL = function() {
            for (var e = {},
            c, d = ["experimental-webgl", "webgl"], m = 0; m < d.length; m++) {
                try {
                    c = this.canvas.getContext(d[m], e)
                } catch(g) {}
                if (c) break
            }
        ...
        a.prototype.getScissorRect = function(a) {
            ...
            m,
            g;
            c ? c.intersects(c) ? (d = Math.max(a.x + this.worldTransform.tx, c.x), m = Math.max(a.y + this.worldTransform.ty, c.y), g = Math.min(a.x + this.worldTransform.tx + a.width, c.x + c.width) - d, a = Math.min(a.y + this.worldTransform.ty + a.height, c.y + c.height) - m) : a = g = m = d = 0: (d = a.x + this.worldTransform.tx, m = a.y + this.worldTransform.ty, g = a.width, a = a.height); (c = this.maskDataFreeList.pop()) ? (c.x = d, c.y = m, c.width = 
            g, c.height = a) : c = new b.Rectangle(d, m, g, a);
            return c
        };
        a.prototype.popMask = function() {
            this._draw();
        ...
        a.prototype.scissor = function(a, c, d, m) {
            var g = this.gl;
            0 > d && (d = 0);
            0 > m && (m = 0);
            g.scissor(a, -c + b.MainContext.instance.stage.stageHeight - m, d, m)
        };
        a.prototype.setGlobalColorTransform = function(a) {
...
var egret_webgl_graphics;
 (function(b) {
    ...
    b.drawCircle = function(b, a, e) {};
    b.drawRoundRect = function(b, a, e, d, l, m) {};
    b.drawEllipse = function(b, a, e, d) {};
    b.lineStyle = function(b, a, e, d, l, m, g, f) {};
    b.lineTo = function(b, a) {};
...
function(b, d) {
 ...
 (function(b) {
    var d = function(c) {
        ...
        a.prototype.proceed = function(a) {
            function c() {
                if (4 == m.readyState) if (m.status != a._status && (a._status = m.status, b.HTTPStatusEvent.dispatchHTTPStatusEvent(a, m.status)), 400 <= m.status || 0 == m.status) b.IOErrorEvent.dispatchIOErrorEvent(a);
                else {
                    switch (a.dataFormat) {
        ...
        a.prototype.loadSound = function(a) {
            ...
            m.__timeoutId = b.setTimeout(c, this, 100);
 ...
 (function(b) {
    var d = function(c) {
        ...
        a.prototype.getLocation = function(a, c) {
            ...
            m = c.pageY) : (g -= document.body.scrollLeft, f -= document.body.scrollTop, d = c.clientX, m = c.clientY);
 ...
 (function(b) {
    var d = function(c) {
        function a() {
            ...
            l.scale.y = d;
            l.transforms();
            l.style[a.getTrans("transformOrigin")] = "0% 0% 0px";
            this.div = l;
            d = b.MainContext.instance.stage;
            e = d.stageWidth;
            d = d.stageHeight;
...
RES;
 (function(b) {
    var d = function(b) {
        ...
        __extends(a, b);
        a.dispatchResourceEvent = function(b, c, d, m, g, f) {
            void 0 === d && (d = "");
            void 0 === m && (m = null);
            void 0 === g && (g = 0);
            void 0 === f && (f = 0);
 ...
 (function(b) {
    var d = function() {
        ...
        c.prototype.parseConfig = function(a, b) {
            if (a) {
                var c = a.resources;
                if (c) for (var d = c.length, m = 0; m < d; m++) {
                    var g = c[m],
                    f = g.url;
                ...
                if (c = a.groups) for (d = c.length, m = 0; m < d; m++) {
                    for (var f = c[m], h = [], n = f.keys.split(","), 
                    p = n.length, q = 0; q < p; q++) g = n[q].trim(),
    ...
    var d = function(c) {
        ...
        a.prototype.onItemComplete = function(a) {
            ...
            if (c) {
                ...
                d == m && (a = this.groupErrorDic[c], this.removeGroupName(c), delete this.groupTotalDic[c], delete this.numLoadedDic[c], delete this.itemListDic[c], delete this.groupErrorDic[c], a ? b.ResourceEvent.dispatchResourceEvent(this, 
...
function(b, d) {
 ...
 (function(b) {
    ...
    b.getResByUrl = function(a, b, d, l) {
        void 0 === l && (l = "");
        c.getResByUrl(a, b, d, l)
    };
    ...
    b.addEventListener = function(a, b, d, l, m) {
        void 0 === l && (l = !1);
        void 0 === m && (m = 0);
        c.addEventListener(a, b, d, l, m)
    };
    b.removeEventListener = function(a, b, d, l) {
        void 0 === l && (l = !1);
        c.removeEventListener(a, b, d, l)
    };
    var d = function(a) {
        function c() {
            a.call(this);
        ...
        c.prototype.startLoadConfig = function() {
            ...
            for (var d = a.length, m = [], g = 0; g < d; g++) {
                var f = a[g],
                f = new b.ResourceItem(f.url, f.url, f.type);
                m.push(f)
            }
            this.resLoader.loadGroup(m, c.GROUP_CONFIG, Number.MAX_VALUE)
        };
        ...
        function(a) {
            if (a.groupName == c.GROUP_CONFIG) {
                ...
                for (var d = 0; d < a; d++) {
                    var m = this.loadingConfigList[d],
                    g = this.getAnalyzerByType(m.type),
                    f = g.getRes(m.url);
                    g.destroyRes(m.url);
                    this.resConfig.parseConfig(f, m.resourceRoot)
                }
        ...
        c.prototype.getResByUrl = function(a, c, d, e) {
            ...
            if (a) {
                ...
                this.asyncDic[a] ? this.asyncDic[a].push(c) : (this.asyncDic[a] = [c], a = new b.ResourceItem(a, 
...
var Status = function() {
    function b() {}
    b.getGradingResult = function(d) {
        for (var c = 0, a = 0; a < b.resultGrading.length; a++) d >= b.resultGrading[a] && c++;
	    console.log(d+'**'+c); 
        return c
    };
    b.reset = function() {
    ...
    b.IS_IPHONE = !1;
    b.DEBUG = !1;
    b.resultGrading = [20, 40, 60];
    b.soundGrading = [15, 40];
    b.artType = 0;
    b.step = 0;
    b.canTap = !0;
    b.brickWidth = 64;
...
Ball = function(b) {
    function d() {
        b.call(this);
        this.checked = !1;
        this.type = this.col = 0;
        this._bm = new egret.Bitmap;
        this.addChild(this._bm);
        this._bm.anchorY = 1;
        this._bm.anchorX = 0.5;
        this._bm.scaleX = this._bm.scaleY = 0.9;
        this._initY = this._bm.y = 28.8
    }
    __extends(d, b);
    d.prototype.init = function(b, a) {
        ...
        this.col = a;
        this.x = (this.col + 
        0.5) * Status.brickWidth;
        this.y = 0;
        this._bm.texture = RES.getRes("game_ball_" + this.type);
        Status.DEBUG && (this.graphics.clear(), this.graphics.lineStyle(3, 16711680), this.graphics.drawRect( - Status.brickWidth / 2, 0, Status.brickWidth, -Status.brickWidth), this.graphics.endFill(), this.graphics.lineStyle(5, 16715760), this.graphics.moveTo( - Status.brickWidth / 2, 0), this.graphics.lineTo(Status.brickWidth / 2, 0))
    };
    d.prototype.bounce = function() {
        egret.Tween.get(this._bm).to({
            y: this._initY - 20
        },
        100).to({
            y: this._initY
        },
        400, egret.Ease.bounceOut)
    };
    d.getBall = function(b, a) {
        void 0 === b && (b = -1);
        void 0 === a && (a = -1);
        var e = d._libs.length ? d._libs.pop() : new d; - 1 == b && (b = Math.floor(3 * Math.random())); - 1 == a && (a = Math.floor(10 * Math.random()));
        e.init(b, a);
        return e
    };
    d.retrieve = function(b) {
        b.parent && b.parent.removeChild(b);
        d._libs.push(b)
    };
    d._libs = new egret.Recycler;
    return d
} (egret.Sprite);
...
Button = function(b) {
    function d() {
        ...
        this.touchEnabled = !0;
        this.addEventListener(egret.TouchEvent.TOUCH_BEGIN, this.onPressed, this);
        this.addEventListener(egret.TouchEvent.TOUCH_END, this.onTapped, this);
        this.addEventListener(egret.TouchEvent.TOUCH_RELEASE_OUTSIDE, 
        this.onReleased, this)
    }
    __extends(d, b);
    d.prototype.initStyle = function(b, a) {
        this._normalTexture = RES.getRes(b);
        this._pressedTexture = RES.getRes(a);
        this.setState()
    };
    d.prototype.initCallback = function(b, a) {
        for (var d = [], k = 2; k < arguments.length; k++) d[k - 2] = arguments[k];
        this._callback = b;
        this._scope = a;
        this._params = d
    };
    d.prototype.setState = function(b) {
        void 0 === b && (b = d.STATE_NORMAL);
        b == d.STATE_NORMAL ? (this.bitmap.texture = this._normalTexture, this.bitmap.y = 0) : (this.bitmap.texture = this._pressedTexture, this.bitmap.y = 
        this._py)
    };
    d.prototype.onPressed = function(b) {
        this.setState(d.STATE_PRESSED)
    };
    d.prototype.onReleased = function(b) {
        this.setState(d.STATE_NORMAL)
    };
    d.prototype.onTapped = function(b) {
        this.setState(d.STATE_NORMAL);
        egret.Tween.get(this, {
            override: !0
        }).wait(this.reactDelay).call(this._callback, this._scope, this._params)
    };
    d.STATE_NORMAL = "normal";
    d.STATE_PRESSED = "pressed";
    return d
...
GameUI = function(b) {
    function d() {
        ...
        this._bgOrder = [0];
        this._bgIndex = 0;
        this._bgInterval = 15E3;
        this._bgTweenTime = 2E3;
        this._hitOffset = 5;
        this._passVar = 1;
        this._dElapsed = 0;
        this._started = !1;
    ...
    __extends(d, b);
    d.prototype.initView = function(b) {
        this.removeEventListener(egret.Event.ADDED_TO_STAGE, 
        this.initView, this);
        this.addEventListener(egret.Event.REMOVED_FROM_STAGE, this.onRemoved, this);
        this._background = new egret.DisplayObjectContainer;
        this.addChild(this._background);
        this._currentBg = new egret.Bitmap;
        this._background.addChild(this._currentBg);
        this._nextBg = new egret.Bitmap;
        this._background.addChild(this._nextBg);
        this._title = new egret.Bitmap(RES.getRes("game_tip_"));
        this.addChild(this._title);
        this._bricks = new egret.DisplayObjectContainer;
        this._bricks.anchorOffsetX = 2 * Status.brickWidth;
        this._bricks.y = 
        926;
        this.addChild(this._bricks);
        this._currentBrick = new egret.Bitmap;
        this._bricks.addChild(this._currentBrick);
        this._nextBrick = new egret.Bitmap;
        this._bricks.addChild(this._nextBrick);
        this._currentBrick.width = this._nextBrick.width = 12 * Status.brickWidth;
        this._currentBrick.height = this._nextBrick.height = Status.brickHeight;
        this._currentBrick.fillMode = this._nextBrick.fillMode = egret.BitmapFillMode.REPEAT;
        this._hitBrick = new egret.Bitmap(RES.getRes("game_brick_hit"));
        this._hitBrick.y = this._bricks.y = 926;
        this.addChild(this._hitBrick);
        this._scoreBg = new egret.Bitmap(RES.getRes("game_text_bg"));
        this._scoreBg.anchorX = 0.5;
        this._scoreBg.x = Status.W >> 1;
        this._scoreBg.y = 80;
        this.addChild(this._scoreBg);
        b = RES.getRes("number-export");
        this._scoreTF = new egret.BitmapText;
        this._scoreTF.font = b;
        this._scoreTF.text = "012";
        this._scoreTF.x = Status.W >> 1;
        this._scoreTF.y = 85;
        this._scoreTF.anchorX = 0.5;
        this.addChild(this._scoreTF);
        this._balls = new egret.DisplayObjectContainer;
        this.addChild(this._balls);
        this._effectBox = new egret.DisplayObjectContainer;
        this.addChild(this._effectBox);
        this._tipBox = new egret.DisplayObjectContainer;
        this._tip = new egret.Bitmap;
        this._tip.anchorX = 0.5;
        this._tip.anchorY = 1;
        this._tipBox.addChild(this._tip);
        this._hitHalo = new egret.Bitmap(RES.getRes("game_halo_hit"));
        this._hitHalo.anchorX = this._hitHalo.anchorY = 0.5;
        this._effectBox.addChild(this._hitHalo);
        this.reset()
    };
    d.prototype.reset = function() {
        egret.Tween.removeTweens(this);
        egret.Tween.removeTweens(this._currentBg);
        egret.Tween.removeTweens(this._currentBrick);
        this._bgOrder = [0];
        for (var b = [1, 2, 3, 4]; 0 < b.length;) this._bgOrder.push(b.splice(Math.floor(b.length * 
        Math.random()), 1)[0]);
        this._bgIndex = Status.artType = 0;
        this._currentBg.texture = RES.getRes("game_bg_" + Status.artType);
        this._currentBrick.texture = RES.getRes("game_brick_" + Status.artType);
        this._scoreTF.visible = this._scoreBg.visible = this._hitHalo.visible = this._hitBrick.visible = !1;
        this._passVar = 1;
        this._bricks.x = 0;
        this.updateScoreView(Status.score)
    };
    d.prototype.start = function() {
        this._started = !0;
        this._dElapsed = Status.brickInterval;
        this._scoreBg.visible = this._scoreTF.visible = !0;
        egret.Tween.get(this._background, 
        {
            override: !0,
            loop: !0
        }).wait(this._bgInterval).call(this.tweenBackground, this)
    };
    d.prototype.onTick = function(b) {
        if (this._started) {
            b = b / 1E3 * (Status.brickVy + Status.incVy);
            this._dElapsed += b;
            if (this._dElapsed >= Status.brickInterval) {
                this._dElapsed = 0;
                var a = Ball.getBall();
                this._balls.addChild(a)
            }
            for (a = 0; a < this._balls.numChildren; a++) {
                var d = this._balls.getChildAt(a);
                d.y += b;
                d.col % 2 != this._passVar && d.y - this._hitOffset > this._bricks.y && d.y + this._hitOffset < this._bricks.y + Status.brickHeight + 0.9 * Status.brickWidth ? 
                this.stop(d) : !d.checked && d.y + this._hitOffset > this._bricks.y + Status.brickHeight + Status.brickWidth ? (d.checked = !0, Status.incVy += 40 > Status.score ? Status.incPerScoreA: Status.incPerScoreB, this.updateScoreView(++Status.score)) : d.y > d.height + Status.H && Ball.retrieve(d)
            }
        }
    };
    d.prototype.stop = function(b) {
        ...
        this._hitBrick.visible = !0;
        this._hitBrick.x = b.col * Status.brickWidth;
        b.bounce();
        this._hitHalo.visible = !0;
        this._hitHalo.x = b.x;
        this._hitHalo.y = 
        b.y - Status.brickWidth / 2;
        this._hitHalo.scaleX = this._hitHalo.scaleY = 0;
        this._hitHalo.alpha = 0;
        this.runParticle(this._hitHalo.x, this._hitHalo.y, 30);
        egret.Tween.get(this._hitHalo, {
            override: !0
        }).set({
            scaleX: 0,
            scaleY: 0,
        ...
        1E3, egret.Ease.cubicOut);
        egret.Tween.get(this, {
            override: !0
        }).wait(1E3).call(this.sendNotification)
    };
    d.prototype.sendNotification = function() {
        this.stage && this.stage.dispatchEvent(new egret.Event(d.EVENT_OVER))
    };
    d.prototype.reactTap = function() {
        2 == 
        Status.step && (this._bricks.x = (this._bricks.x + Status.brickWidth) % (2 * Status.brickWidth), this._passVar = (this._passVar + 1) % 2)
    };
    d.prototype.tweenBackground = function() {
        this._started && (this._bgIndex = (this._bgIndex + 1) % this._bgOrder.length, Status.artType = this._bgOrder[this._bgIndex], this._nextBg.alpha = 0, this._nextBg.texture = RES.getRes("game_bg_" + Status.artType), this._background.addChild(this._nextBg), egret.Tween.get(this._nextBg, {
            override: !0
        }).to({
            alpha: 1
        },
        this._bgTweenTime), this._currentBg = this._nextBg, this._nextBg = 
        this._background.getChildAt(0), this._nextBrick.alpha = 0, this._nextBrick.texture = RES.getRes("game_brick_" + Status.artType), this._bricks.addChild(this._nextBrick), egret.Tween.get(this._nextBrick, {
            override: !0
        }).to({
            alpha: 1
        },
        this._bgTweenTime), this._currentBrick = this._nextBrick, this._nextBrick = this._bricks.getChildAt(0))
    };
    d.prototype.updateScoreView = function(b) {
        var a = b + "";
        this._scoreTF.text = a;
        this._scoreBg.scaleX = a.length;
        b = Status.resultGrading.indexOf(b); - 1 != b && (this._effectBox.addChild(this._tipBox), 
        this._tip.texture = RES.getRes("game_tip_" + (b + 1)), this._tip.x = -5, this._tip.y = -5, egret.Tween.removeTweens(this._tip), egret.Tween.get(this._tip, {
            loop: !0
        }).to({
            x: 5
        },
        ...
        2E3, egret.Ease.sineInOut), egret.Tween.get(this._tip, {
            loop: !0
        }).to({
            y: 5
        },
        1400, egret.Ease.sineInOut).to({
            y: -5
        },
        1400, egret.Ease.sineInOut), this._tipBox.alpha = 0, this._tipBox.x = 442, this._tipBox.y = 2, egret.Tween.get(this._tipBox, {
            override: !0
        }).to({
            alpha: 1,
            x: 320,
        ...
        500, egret.Ease.circOut).wait(2500).to({
            alpha: 0,
            x: 286,
            y: 460
        },
        300, egret.Ease.circIn).call(this.clearTip, this))
    };
    d.prototype.clearTip = function() {
        egret.Tween.removeTweens(this._tip);
        this._effectBox.removeChild(this._tipBox)
    };
    d.getParticleShape = function() {
        var b;
        this._shadeLibs.length ? b = this._shadeLibs.pop() : (b = new egret.Shape, b.graphics.clear(), b.graphics.beginFill(9373479), b.graphics.drawRect(0, 0, 20, 12), b.graphics.endFill(), b.anchorX = b.anchorY = 0.5, b.alpha = 0.5);
        return b
    };
    d.retrieveParticleShape = function(b) {
        b.parent && b.parent.removeChild(b);
        d._shadeLibs.push(b)
    };
    d.prototype.runParticle = function(b, a, e) {
        void 0 === e && (e = 30);
        for (var k = 0; k < e; k++) {
            var l = d.getParticleShape();
            this._effectBox.addChildAt(l, 0);
            l.visible = !1;
            l.x = b;
            l.y = a;
            var m = 60 * Math.random() + 30,
            g = Math.random() * Math.PI * 2,
            f = b + m * Math.cos(g),
            g = a + m * Math.sin(g);
            egret.Tween.get(l).wait(100 * Math.random()).set({
                visible: !0
            },
            l).to({
                x: f,
            ...
            12 * m, egret.Ease.circOut).call(d.retrieveParticleShape, d, [l])
        }
    };
    d.prototype.onRemoved = function(b) {
        this.removeEventListener(egret.Event.REMOVED_FROM_STAGE, this.onRemoved, 
        this)
    };
    d.EVENT_START = "event_start";
    d.EVENT_OVER = "event_over";
    d._shadeLibs = new egret.Recycler;
    return d
} (egret.Sprite);
...
EntryUI = function(b) {
    ...
    d.prototype.initView = function() {
        this._title = new egret.Bitmap(RES.getRes("game_title"));
        this._title.anchorX = 0.5;
        this._titleStart = new egret.Bitmap(RES.getRes("game_title_start"));
        this._titleStart.anchorX = this._titleStart.anchorY = 0.5;
        this._tip = 
        new egret.Bitmap(RES.getRes("game_instruction"));
        this._tip.anchorX = this._tip.anchorY = 0.5;
        this.reset();
        this.runAnimation()
    };
    d.prototype.reset = function() {
        this._title.x = Status.W >> 1;
        this._title.y = 88;
        this.addChild(this._title);
        this._titleStart.x = Status.W >> 1;
        this._titleStart.y = 240;
        this._titleStart.alpha = 1;
        this.addChild(this._titleStart);
        this._tip.x = (Status.W >> 1) - this._distX;
        this._tip.y = 500;
        this.addChild(this._tip)
    };
    d.prototype.runAnimation = function() {
        egret.Tween.get(this._titleStart, {
            loop: !0
        }).to({
            alpha: 0
        },
        300, egret.Ease.sineInOut).to({
            alpha: 1
        },
        300, egret.Ease.sineInOut).to({
            alpha: 0
        ...
        300, egret.Ease.sineInOut).wait(3E3)
    };
    d.prototype.onStep0 = function() {
        window.meiriq_game.cb_start() && (this.reset(), egret.Tween.get(this._titleStart, {
            override: !0
        }).to({
            x: this._titleStart.x + this._distX
        },
        300, egret.Ease.cubicOut).call(this.removeChild, this, [this._titleStart]), egret.Tween.get(this._title, {
            override: !0
        }).wait(50).to({
            x: this._title.x + 
            this._distX
        },
        300, egret.Ease.cubicOut).call(this.removeChild, this, [this._title]), egret.Tween.get(this._tip, {
            override: !0
        }).wait(100).to({
            x: this._tip.x + this._distX
        },
        300, egret.Ease.cubicInOut), Status.step = 1)
    };
    d.prototype.onStep1 = function() {
        Status.step = 2;
        Status.canTap = !1;
        egret.Tween.get(this._tip, {
            override: !0
        }).to({
            x: Status.W + this._distX
        },
        300, egret.Ease.sineOut).call(this.sendNotification, this)
    };
    d.prototype.sendNotification = function() {
        this.removeChild(this._tip);
        Status.canTap = !0;
        this.stage && this.stage.dispatchEvent(new egret.Event(GameUI.EVENT_START))
    };
    return d
} (egret.DisplayObjectContainer);
EntryUI.prototype.__class__ = "EntryUI";
var HTMLInterface = function() {
    function b() {}
    b.getSoundCtrl = function() {
        this._soundCtrl || (this._soundCtrl = new window.may.SoundCtrl);
        return this._soundCtrl
    };
    b.call = function(b) {
        for (var c = [], a = 1; a < arguments.length; a++) c[a - 1] = arguments[a];
        window[b] instanceof Function ? window[b].apply(null, c) : console.log("Try to call global function('" + b + "') but NO SUCH FUNCTION defined.")
    };
    b.bind = function(b, c) {
        window[c] = b
    };
    b.saveToLocalStorage = function(b) {
        localStorage.setItem(this.STORAGE_KEY, b);
        window[this.STORAGE_KEY] = 
        b
    };
    b.getLocalStorageValue = function(b) {
        void 0 === b && (b = this.STORAGE_KEY);
        var c = 0;
        localStorage && localStorage.getItem(b) && (c = parseInt(localStorage.getItem(b)));
        localStorage.getItem(b);
        return c
    };
    b.CB_START = "cb_start";
    b.CB_GAMEOVER = "cb_gameover";
    b.CB_FINISHLOAD = "cb_finishload";
    b.CB_RESTART = "cb_restart";
    b.CB_SHARE = "cb_share";
    b.CB_MORE = "cb_more";
    b.STORAGE_KEY = "cantstopScore";
    return b
} ();
HTMLInterface.prototype.__class__ = "HTMLInterface";
var __extends = this.__extends || 
function(b, d) {
    function c() {
        this.constructor = b
...
ResultUI = function(b) {
    ...
    d.prototype.initView = function(b) {
        this.x = Status.W >> 1;
        this._stopY = this.y = Status.H >> 1;
        this.createButton(d.BUTTON_MORE, "ui_result.ui_result_more", "ui_result.ui_result_more1");
        this.createButton(d.BUTTON_REPLAY, "ui_result.ui_result_replay", "ui_result.ui_result_replay1");
        this.createButton(d.BUTTON_SHARE, "ui_result.ui_result_share", "ui_result.ui_result_share1");
        var a = new egret.Bitmap(RES.getRes("ui_result.ui_result_bg"));
        a.anchorX = 0.5;
        a.y = 90;
        this.addChild(a);
        this._centerBox = new egret.DisplayObjectContainer;
        this._centerBox.x = 0;
        this._centerBox.y = 300;
        this.addChild(this._centerBox);
        this._currentTxt = new egret.BitmapText;
        this._currentTxt.font = b;
        this._currentTxt.anchorX = 0.5;
        this._currentTxt.text = "0";
        this._currentTxt.scaleX = this._currentTxt.scaleY = 137 / this._currentTxt.height;
        this.addChild(this._currentTxt);
        this._highestTxt = new egret.TextField;
        this._highestTxt.anchorX = 0.5;
        this._highestTxt.y = 155;
        this._highestTxt.textColor = 7829367;
        this._highestTxt.fontFamily = "\u5fae\u8f6f\u96c5\u9ed1";
        this._highestTxt.text = "\u6700\u9ad8 777";
        this.addChild(this._highestTxt);
        this._buttonBox = new egret.DisplayObjectContainer;
        this._buttonBox.anchorX = 0.5;
        this._buttonBox.y = 448;
        this.addChild(this._buttonBox);
        this.anchorOffsetY = 0.6 * this.height;
        this._startY = -this.height;
        this.visible = !1
    };
    d.prototype.show = 
    function(b, a, d, k, l) {
        void 0 === k && (k = 0);
        void 0 === l && (l = 0);
        this._centerBox.removeChildren();
        b && this._centerBox.addChild(b);
        this._buttonBox.removeChildren();
        this._leftButton = this._buttonMap[a];
        this._rightButton = this._buttonMap[d];

        this._rightButton.x = a == d ? 0: this._leftButton.width + 30;
        this._buttonBox.addChild(this._leftButton);
        this._buttonBox.addChild(this._rightButton);
        this._currentTxt.text = k + "";
        this._highestTxt.text = "\u6700\u9ad8 " + l;
        this.visible = !0;
        this.y = this._startY;
        egret.Tween.get(this, {
            override: !0
    ...
    d.prototype.hide = function() {
        this.visible = !1;
        this._buttonBox.touchEnabled = !1
    };
    d.prototype.createButton = function(b, a, d) {
        var k = new Button;
        k.name = b;
        k.initStyle(a, d);
        k.initCallback(this.sendNotification, this, k.name);
        return this._buttonMap[b] = k
    };
    d.prototype.sendNotification = function(b) {
        this.stage && this.stage.dispatchEvent(new egret.Event(b))
    };
    d.BUTTON_SHARE = "share";
    d.BUTTON_MORE = "more";
    d.BUTTON_REPLAY = "replay";
    return d
} (egret.DisplayObjectContainer);
ResultUI.prototype.__class__ = "ResultUI";
var __extends = this.__extends || 
function(b, d) {
    function c() {
        this.constructor = b
...
Main = function(b) {
    ...
    d.prototype.onConfigComplete = function(b) {
        ...
        RES.addEventListener(RES.ResourceEvent.GROUP_COMPLETE, this.onResourceLoadComplete, 
        this);
    ...
    d.prototype.onAddToStage = function(b) {
        Status.IS_IPHONE = /iPhone/i.test(navigator.userAgent);
        Status.W = 640;
        Status.H = 1136;
        this.stage.stageWidth / 
        this.stage.stageHeight > 640 / 1136 ? (this.scaleX = this.scaleY = this.stage.stageHeight / 1136, this.x = 0.5 * (this.stage.stageWidth - 640 * this.scaleX)) : (this.scaleY = this.scaleX = this.stage.stageWidth / 640, this.y = 0.5 * (this.stage.stageHeight - 1136 * this.scaleY));
        this.scaleX = this.scaleY = Status.IS_IPHONE ? 1: 0.5;
        window.home = this.reset;
        ...
        this);
        RES.loadConfig("resource/resource.json", window.meiriq_game.resourceCDN + "resource/assets/");
        HTMLInterface.getSoundCtrl().assetsPath = window.meiriq_game.resourceCDN + "resource/assets/";
        HTMLInterface.getSoundCtrl().startLoad(this.checkAllResourceComplete, this)
    };
    d.prototype.onResourceLoadComplete = function(b) {
        "preload" == b.groupName && (RES.removeEventListener(RES.ResourceEvent.GROUP_COMPLETE, this.onResourceLoadComplete, this), RES.removeEventListener(RES.ResourceEvent.GROUP_LOAD_ERROR, this.onResourceLoadError, 
        this), RES.removeEventListener(RES.ResourceEvent.GROUP_PROGRESS, this.onResourceProgress, this), this._artsLoaded = !0, this.checkAllResourceComplete())
    };
    d.prototype.checkAllResourceComplete = function() {
       HTMLInterface.getSoundCtrl().loaded && this._artsLoaded && (this.createWorld(), window.play_load.finish(), window.meiriq_game.cb_finishload())
    };
    d.prototype.createWorld = function() {
        this.initListeners();
        this.initViews()
    };
    d.prototype.initListeners = function() {
        ...
        this.stage.addEventListener(GameUI.EVENT_START, this.onNotifications, this);
        this.stage.addEventListener(GameUI.EVENT_OVER, this.onNotifications, this);
        this.stage.addEventListener(ResultUI.BUTTON_MORE, this.onNotifications, this);
        this.stage.addEventListener(ResultUI.BUTTON_REPLAY, this.onNotifications, this);
        this.stage.addEventListener(ResultUI.BUTTON_SHARE, this.onNotifications, this)
    };
    d.prototype.initViews = function() {
        Status.reset();
        this._game = new GameUI;
        this.addChild(this._game);
        this._entryUI = new EntryUI;
        this.addChild(this._entryUI);
        if (Status.DEBUG) {
            var b = new egret.Shape;
            b.graphics.beginFill(0);
            b.graphics.drawRect(0, 0, 150, 90);
            b.graphics.endFill();
    ...
    d.prototype.onNotifications = function(b) {
        switch (b.type) {
        case GameUI.EVENT_START:
            this._game.start();
            break;
        case GameUI.EVENT_OVER:
            this.showResult();
            break;
        case ResultUI.BUTTON_MORE:
            HTMLInterface.call(HTMLInterface.CB_MORE);
            break;
        case ResultUI.BUTTON_REPLAY:
            HTMLInterface.call(HTMLInterface.CB_RESTART);
            break;
        case ResultUI.BUTTON_SHARE:
            HTMLInterface.call(HTMLInterface.CB_SHARE)
        }
    };
    d.prototype.pause = function() {
        egret.Ticker.getInstance().pause();
        this.touchChildren = !1;
        HTMLInterface.getSoundCtrl().pause()
    };
    d.prototype.resume = function() {
        this._lastTime = egret.getTimer();
        this.touchChildren = !0;
        egret.Ticker.getInstance().resume();
        HTMLInterface.getSoundCtrl().resume()
    };
    d.prototype.reset = function() {
        egret.Tween.removeAllTweens();
        this.removeChildren();
        this.initViews();
        HTMLInterface.getSoundCtrl().dispose()
    };
    d.prototype.onKeyboard = function(b) {
        var a = this.context;
        switch (b.keyCode) {
        case 13:
            a.touchChildren ? a.pause() : a.resume();
            break;
        case 32:
            a.reset()
        }
    };
    d.prototype.showResult = function() {
        window.meiriq_game.cb_gameover(Status.score, "game_grading_" + Status.getGradingResult(Status.score) + ".png")
    };
    d.prototype.onTick = function(b) {
        b = egret.getTimer();
        this._lastTime = this._lastTime ? this._lastTime: b;
    ...
    d.prototype.onTap = 
    function(b) {
        if (Status.canTap) switch (Status.step) {
        case 0:
            this._entryUI.onStep0();
            break;
        case 1:
            this._entryUI.onStep1();
            HTMLInterface.getSoundCtrl().launchSound();
            break;
        case 2:
            this._game.reactTap()
        }
